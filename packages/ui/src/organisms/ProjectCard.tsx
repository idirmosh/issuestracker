  ...
  return (
    <Link href={`/${project.slug}`}>
      <a className="col-span-1 flex min-w-[370px] max-w-md flex-col rounded-lg border border-gray-200 bg-white shadow-sm hover:shadow-md">
        ...
        <div className="flex border-t border-gray-200 py-4 px-6">
          ...
          <div className="ml-auto flex items-end space-x-8">
            <span className="felx flex-row justify-between text-center">
              <FlagIcon className="mx-auto mb-1 h-4 w-4 fill-orange-400" />
            ...
            <span className="felx flex-row justify-between text-center">
              <FlagIcon className="mx-auto mb-1 h-4 w-4 fill-green-400" />
            ...
            <span className="felx flex-row justify-between text-center">
              <FlagIcon className="mx-auto mb-1 h-4 w-4 fill-blue-400" />
